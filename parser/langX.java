...
RecoverySet f1 = new RecoverySet(SEMICOLON).union(g),
      ...
      try {
        ...
        jj_consume_token(RPAREN);
        s3 = statement(g);
{if ("" != null) return new WhileNode(t, e1, s3);}
      } catch (ParseException e) {
...
RecoverySet f1 = new RecoverySet(SEMICOLON).union(g),
      ...
      try {
        ...
        jj_consume_token(RPAREN);
{if ("" != null) return new DoWhileNode(t, e1, s3);}
      } catch (ParseException e) {
...
Token t = null;
      try {
        ...
        sw1 = switchcasesstat(g);
        jj_consume_token(RBRACE);
{if ("" != null) return new SwitchNode(t, sw1);}
      } catch (ParseException e) {
consumeUntil(g, e, "switchstat");
  ...
  final public SwitchCaseNode switchcasesstat(RecoverySet g) throws ParseException, ParseEOFException {
    trace_call("switchcasesstat");
    try {StatementNode s = null;
ExpreNode e1 = null;
Token t = null;
RecoverySet f1 = new RecoverySet(COLON).union(g);
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case CASE:
        case DEFAULTCASE:{
          ...
          case DEFAULTCASE:{
            t = jj_consume_token(DEFAULTCASE);
            break;
            }
          default:
            jj_la1[28] = jj_gen;
...
{if ("" != null) return l;}
  ...
  private boolean jj_3R_16()
 {
    ...
    if (jj_scan_token(30)) {
    jj_scanpos = xsp;
    if (jj_scan_token(28)) { if (!jj_rescan) trace_return("vardecl(LOOKAHEAD FAILED)"); return true; }
    }
    }
    }
    }
